...
ParticleSlider.prototype.init = function(a) {
    ...
    if (b.imgs.length > 0) {
        ...
        b.srcCtx.arc(0, 0, b.$srcCanv.width, b.$srcCanv.height, 2 * Math.PI),
        ...
        if (b.showArrowControls == !0) {
            b.prevCtx.arc(0, 0, b.$prevCanv.width, b.$prevCanv.height, 2 * Math.PI),
            ...
            for (var e = 0, f = d.length; e < f; e++)
                ...
                ,
                c.push(d[e]);
            b.nextCtx.arc(0, 0, b.$nextCanv.width, b.$nextCanv.height, 2 * Math.PI),
